...
import { CHORDS, CHORDS_MAP } from './constants';
   ...
   * @type {String}
	*/
	...
	_createChord(chordName) {
		...
		const chord = CHORDS_MAP.get(chordType)[0];
...
Chord.MAJOR = CHORDS.MAJOR;
Chord.MINOR = CHORDS.MINOR;
Chord.AUG = CHORDS.AUG;
Chord.DIM = CHORDS.DIM;
Chord.SUS2 = CHORDS.SUS2;
Chord.SUS4 = CHORDS.SUS4;
Chord.P5 = CHORDS.P5;
Chord.SEVEN = CHORDS.SEVEN;
Chord.MINOR_SEVEN = CHORDS.MINOR_SEVEN;
Chord.MINOR_SEVEN_FLAT_FIVE = CHORDS.MINOR_SEVEN_FLAT_FIVE;
Chord.MAJOR_SEVEN = CHORDS.MAJOR_SEVEN;
Chord.MAJOR_SIX = CHORDS.MAJOR_SIX;
Chord.MINOR_SIX = CHORDS.MINOR_SIX;
Chord.MINOR_SIX_ADD_NINE = CHORDS.MINOR_SIX_ADD_NINE;
Chord.MAJOR_SIX_ADD_NINE = CHORDS.MAJOR_SIX_ADD_NINE;
Chord.NINE = CHORDS.NINE;
Chord.MINOR_NINE = CHORDS.MINOR_NINE;
Chord.MAJOR_NINE = CHORDS.MAJOR_NINE;
Chord.ELEVEN = CHORDS.ELEVEN;
Chord.MINOR_ELEVEN = CHORDS.MINOR_ELEVEN;
Chord.MAJOR_ELEVEN = CHORDS.MAJOR_ELEVEN;
Chord.THIRTEEN = CHORDS.THIRTEEN;
Chord.MINOR_THIRTEEN = CHORDS.MINOR_THIRTEEN;
Chord.MAJOR_THIRTEEN = CHORDS.MAJOR_THIRTEEN;
